---
page_title: "extract_account_id function - nullplatform"
subcategory: ""
description: |-
...
locals {
  ...
  account_id = provider::nullplatform::extract_account_id(var.namespace_nrn)
}
```
...
```text
extract_account_id(nrn string) string
```
