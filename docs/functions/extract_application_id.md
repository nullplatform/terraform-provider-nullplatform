---
page_title: "extract_application_id function - nullplatform"
subcategory: ""
description: |-
  Extract the application id from an NRN
---

# Function: extract_application_id
...
locals {
  ...
  application_id = provider::nullplatform::extract_application_id(var.application_nrn)
}
...
```text
extract_application_id(nrn string) string
```
