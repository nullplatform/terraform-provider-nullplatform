---
page_title: "extract_organization_id function - nullplatform"
subcategory: ""
description: |-
  Extract the organization id from an NRN
---

# Function: extract_organization_id
...
locals {
  ...
  organization_id = provider::nullplatform::extract_organization_id(var.nrn)
}
```
...
```text
extract_organization_id(nrn string) string
```
